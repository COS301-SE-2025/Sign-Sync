    ...
    handlePrediction = (prediction) => {
        ...
        if(prediction.toLowerCase() === currentLetter) {
            this.setState((prevState) => {
                ...
                const firstLetterSigned = !prevState.hasSignedFirstLetter && newCompleted.size === 1;

                if (firstLetterSigned) {
                    setSessionData({ hasSignedFirstLetter: true });
                    AchievementChecker.checkAchievements(
                        this.state.user.userID, 
                        9 
                    );
                ...
                return {
                    ...
                    hasSignedFirstLetter: firstLetterSigned || prevState.hasSignedFirstLetter
                };
            });
        }
    };
